...
<ul>
	<ul>
   	 ...
   	 <li>
        <input type="checkbox" name="todo" onclick="window.location.href='todoasli.php?status=<?php echo($value['status']==1)? '0': '1'; ?>&key=<?php echo $key;?>'";
        ...
        <a href="todoasli.php?hapus=1&key=<?php echo $key;?>" onclick="return confirm('Apakah Anda Yakin akan menghapus data ini?')">hapus</a>
    </li>
	<?php endforeach; ?>
</ul>